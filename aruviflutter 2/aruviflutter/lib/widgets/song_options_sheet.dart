          ...
          Padding(
            ...
            child: Column(
              children: [
                ...
                _buildOptionTile(Icons.playlist_add, 'Add to Playlist', () => _showAddToPlaylist(context)),
                _buildOptionTile(Icons.queue_music, 'Add to Queue', () {
                  AudioService().addToQueue(widget.song);
                  Navigator.pop(context);
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                      content: const Text('Added to Queue', style: TextStyle(color: Colors.black)),
                      duration: const Duration(seconds: 3),
                      backgroundColor: Colors.white,
                      action: SnackBarAction(
                        label: 'Open',
                        textColor: const Color(0xFF1DB954), // Spotify Green
                        onPressed: () {
                          showModalBottomSheet(
                            context: context,
                            backgroundColor: Colors.transparent,
                ...
                _buildOptionTile(Icons.queue_play_next, 'Go to Queue', () {
                  Navigator.pop(context);
                  showModalBottomSheet(
                    context: context,
                    backgroundColor: Colors.transparent,
