            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  if (hasLyrics && !audioService.isAdPlaying)
                    GestureDetector(
                ...
                children: [
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        Text(
                          audioService.isAdPlaying ? (audioService.currentAd?.adTitle ?? 'Advertisement') : (song.audioName ?? 'Unknown Song'),
                        ...
                        Text(
                          audioService.isAdPlaying ? 'Advertisement' : (AudioService().currentPlaylistName ?? widget.currentSong.categoryName ?? 'Unknown Artist'),
                ...
                children: [
                  SliderTheme(
                    ...
                    child: Slider(
                      ...
                      onChanged: (value) {
                        if (audioService.isAdPlaying) return; // Disable seeking for ads
              ...
              Row(
                ...
                children: [
                  IconButton(
                    icon: Icon(Icons.skip_previous, color: audioService.isAdPlaying ? Colors.white30 : Colors.white, size: 36),
                    onPressed: audioService.isAdPlaying ? null : () => audioService.skipToPrevious(),
                  ...
                  const SizedBox(width: 24),
                  IconButton(
                    icon: Icon(Icons.skip_next, color: audioService.isAdPlaying ? Colors.white30 : Colors.white, size: 36),
                    onPressed: audioService.isAdPlaying ? null : () => audioService.skipToNext(),
                    padding: const EdgeInsets.all(12),
                  ),
                  const SizedBox(width: 24),
                  IconButton(
      ...
      children: [
        Center(
          child: Container(
            ...
            child: ClipRRect(
              borderRadius: BorderRadius.circular(16),
              child: audioService.isAdPlaying && audioService.currentAd != null
                  ? (audioService.currentAd!.adType == 'video' && audioService.adVideoController != null && audioService.adVideoController!.value.isInitialized
                      ? AspectRatio(
                          aspectRatio: audioService.adVideoController!.value.aspectRatio,
                          child: VideoPlayer(audioService.adVideoController!),
                        )
                      : (audioService.currentAd!.imageUrl.isNotEmpty
                          ? CachedNetworkImage(
                              imageUrl: audioService.currentAd!.imageUrl,
                              fit: BoxFit.cover,
