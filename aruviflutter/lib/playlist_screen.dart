                      ...
                      AnimatedBuilder(
                        ...
                        builder: (context, child) {
                          ...
                          return FutureBuilder<bool>(
                            future: () async {
                              if (widget.songs.isEmpty) return false;
                            ...
                            builder: (context, snapshot) {
                              ...
                              return _buildIconButton(Icons.download_outlined, () {
                                DownloadService().downloadPlaylist(widget.categoryId, widget.title, widget.songs);
                              });
                            }
                          );
                        }
                  ...
                  builder: (context, child) {
                    ...
                    return ListTile(
                      ...
                      leading: Container(
                        ...
                        child: FutureBuilder<String>(
                          future: () async {
                            final dir = await getApplicationDocumentsDirectory();
                            if (song.songId != null) {
                              final songFile = File('${dir.path}/song_${song.songId}.jpg');
                              if (songFile.existsSync()) return songFile.path;
                            }
                            // Fallback to playlist cover if song cover not found locally
                            final playlistFile = File('${dir.path}/playlist_${widget.categoryId}.jpg');
                            ...
                            if (imgUrl.isNotEmpty) {
                              return ClipRRect(
                                ...
                                child: CachedNetworkImage(
                                  imageUrl: imgUrl,
                                  fit: BoxFit.cover,
                                  errorWidget: (context, url, error) => const Icon(Icons.movie_creation_outlined, color: Colors.white24),
                                ),
                              );
                            }
                      ...
                      trailing: Row(
                        ...
                        children: [
                          FutureBuilder<bool>(
                            future: song.songId != null ? DatabaseService().isDownloaded(song.songId!) : Future.value(false),
                            builder: (context, snapshot) {
